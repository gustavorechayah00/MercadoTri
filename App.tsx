...
const translations = {
  es: {
    ...
    analyzingDesc: 'Gemini AI está analizando tus fotos y BUSCANDO PRECIOS EN ARGENTINA.',
  ...
  en: {
    ...
    analyzingDesc: 'Gemini AI is analyzing your photos and SEARCHING MARKET PRICES IN ARGENTINA.',
